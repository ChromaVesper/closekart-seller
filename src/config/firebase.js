...
const firebaseConfig = {
  ...
  storageBucket: import.meta.env.VITE_FIREBASE_STORAGE_BUCKET || "closekart-8f6b0.appspot.com",
...
// Explicitly pass both bucket formats to ensure SDK connects correctly
const storageBucketUrl =
  import.meta.env.VITE_FIREBASE_STORAGE_BUCKET ||
  "closekart-8f6b0.appspot.com";
export const storage = getStorage(app, `gs://${storageBucketUrl.replace(/^gs:\/\//, '')}`);
